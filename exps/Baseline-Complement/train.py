...
def train(conf):
    ...
    data_features = ['seq','part_pcs', 'part_poses', 'part_valids', 'shape_id', 'part_ids', 'match_ids']
...
def forward(batch, data_features, network, conf, \
    ...
    # get instance label
    instance_label = torch.zeros(batch_size, num_part, num_part).to(conf.device) # B x P x P
